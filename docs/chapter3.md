...
| US14 | Formulario de contacto | Como visitante, deseo enviar mis dudas mediante un formulario de contacto, para recibir asesoría antes de usar la plataforma. | **Scenario 1: Envío válido de consulta**<br>_Given_ que el visitante accede al formulario de contacto<br>_When_ completa los campos obligatorios con información válida y envía el formulario<br>_Then_ el sistema valida los datos ingresados<br>_And_ muestra un mensaje de confirmación indicando que la consulta fue enviada correctamente.<br><br>**Scenario 2: Datos inválidos o incompletos**<br>_Given_ que el visitante intenta enviar una consulta<br>_When_ existen campos obligatorios vacíos o el correo electrónico tiene un formato inválido<br>_Then_ el sistema impide el envío del formulario<br>_And_ muestra mensajes indicando los campos que deben corregirse. | EP06 |
